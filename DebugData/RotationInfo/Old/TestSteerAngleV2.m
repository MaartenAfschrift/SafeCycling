...
yRot2 = opti.variable(nfr,1);
zRot2 = opti.variable(nfr,1);
...
for i =1:nfr
    ...
    R_STangle = rotx_casadi(xRot2(i)) * roty_casadi(yRot2(i)) * rotz_casadi(zRot2(i));
    Error_R = R_steer - R_STangle;
    J = J + sumsqr(Error_R);
end

J = J +  sumsqr(yRot2) + sumsqr(zRot2);
opti.minimize(J);

function [tStart,tEnd,BoolSkipped,BoolDrift] = GUI_ShoulderCheck_Events(Phases,name,varargin)
...
% figure with angular velocity
h1 = subplot(3,1,1);
plot(Phases.Trunk.DualTask.t,Phases.Trunk.DualTask.QdWorld(:,3),'LineWidth',2); hold on;
...
% figure with orientation pelvis
h3 = subplot(3,1,3);
